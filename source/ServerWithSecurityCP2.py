                ...
                while True:
                    match convert_bytes_to_int(read_bytes(client_socket, 8)):
                        ...
                        case 1:
                            ...
                            encrypted_file_len = convert_bytes_to_int(
                                read_bytes(client_socket, 8)
                            )
                        ...
                        case 4:
                            encrypted_session_key_bytes_len = convert_bytes_to_int(read_bytes(client_socket, 8))
                            encrypted_session_key_bytes = read_bytes(client_socket, encrypted_session_key_bytes_len)
                            session_key_bytes = private_key.decrypt(
                                encrypted_session_key_bytes,  # in bytes
